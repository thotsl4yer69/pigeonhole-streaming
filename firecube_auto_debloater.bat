@echo off
REM FireCube Auto-Debloater Script
REM Removes Amazon bloatware and optimizes the system

echo === FireCube Auto-Debloater ===
echo This script will automatically remove Amazon bloatware
echo.
